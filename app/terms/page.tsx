      ...
      <Container size="md" padding="lg">
        <div className="space-y-8">
          ...
          <div className="max-w-none space-y-8">
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-gray-900">2. Device Assessment & Quotation</h2>
              <p className="text-gray-500 leading-relaxed">
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-gray-900">3. Repair Timeline</h2>
              <p className="text-gray-500 leading-relaxed">
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-gray-900">4. Warranty Terms</h2>
              <p className="text-gray-500 leading-relaxed">
                Warranty covers the specific repair performed and parts replaced. Warranty is void if: the device undergoes further repair by another party, the device is physically damaged after our repair, or the device is exposed to liquid or extreme conditions. See our <Link href="/warranty" className="text-sky-500 hover:text-sky-600">Warranty Policy</Link> for details.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-gray-900">6. Unclaimed Devices</h2>
              <p className="text-gray-500 leading-relaxed">
