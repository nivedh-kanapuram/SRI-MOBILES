...
export default function RefundPage() {
  return (
    <Section id="refund" variant="gradient">
      <Container size="md" padding="lg">
        <div className="space-y-8">
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-white">1. No-Fix, No-Fee Policy</h2>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-white">3. Non-Refundable Situations</h2>
              <ul className="text-dark-400 leading-relaxed space-y-2 list-disc list-inside">
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-white">4. Refund Process</h2>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-white">5. Damaged Device Compensation</h2>
              <p className="text-dark-400 leading-relaxed">
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-white">6. Contact for Refunds</h2>
              <p className="text-dark-400 leading-relaxed">
